...
public:
	...
	// 경로 검색 함수.
	std::vector<Node*> FindPath(Node* startNode, Node* goalNode, const std::vector<std::vector<int>>& grid, int time);
...
private:
	...
	void DisplayGridWithoutPath(std::vector<std::vector<int>> grid);
